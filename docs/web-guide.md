...
|-------|:------:|----------|
| `/web-publish` | `.py` | Публикация базы (VRD + httpd.conf + запуск Apache) |
| `/web-info` | `.py` | Статус Apache и список публикаций |
| `/web-stop` | `.py` | Остановка Apache |
| `/web-unpublish` | `.py` | Удаление публикации (одной или всех `--all`) |
