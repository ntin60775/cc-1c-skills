...
| `/db-create` | `.py` | Создание информационной базы |
| `/db-dump-cf` | `.py` | Выгрузка конфигурации в CF-файл |
| `/db-load-cf` | `.py` | Загрузка конфигурации из CF-файла |
| `/db-dump-xml` | `.py` | Выгрузка конфигурации в XML-файлы (полная/инкрементальная/частичная) |
| `/db-load-xml` | `.py` | Загрузка конфигурации из XML-файлов (полная/частичная) |
| `/db-update` | `.py` | Обновление конфигурации БД |
| `/db-run` | `.py` | Запуск 1С:Предприятие |
| `/db-load-git` | `.py` | Загрузка изменений из Git в базу |
