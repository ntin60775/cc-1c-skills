...
| TASK-2026-0006 | — | готово | высокий | main | [knowledge/tasks/TASK-2026-0006-remove-powershell](knowledge/tasks/TASK-2026-0006-remove-powershell) | Полное удаление PowerShell 5.1 и Windows legacy из проекта, Python 3 — единственный рантайм |
