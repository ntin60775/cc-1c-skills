...
# /skill:cfe-borrow — Заимствование объектов из конфигурации
...
Расширение должно быть создано (`/skill:cfe-init`) и содержать валидный `Configuration.xml`.
...
1. `/skill:cfe-borrow` с `-BorrowMainAttribute` — заимствовать форму с реквизитами
2. `/skill:meta-edit` — добавить новый реквизит в объект расширения
3. `/skill:form-edit` — вывести реквизит на заимствованную форму
...
```
/skill:cfe-validate <ExtensionPath>
```
