...
# /skill:meta-edit — точечное редактирование метаданных 1С
...
```
/skill:meta-validate <ObjectPath>    — валидация после редактирования
/skill:meta-info <ObjectPath>        — визуальная сводка
```
